...
class PointsResourceIT {
    ...
    void putExistingPoints() throws Exception {
        ...
        updatedPoints.date(UPDATED_DATE).exercice(UPDATED_EXERCICE).meals(UPDATED_MEALS).alcohol(UPDATED_ALCOHOL).notes(UPDATED_NOTES);
        ...
        await()
            ...
            .untilAsserted(() -> {
                ...
                assertThat(testPointsSearch.getExercice()).isEqualTo(UPDATED_EXERCICE);
