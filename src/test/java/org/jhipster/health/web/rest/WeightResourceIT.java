...
class WeightResourceIT {
    ...
    public static Weight createEntity(EntityManager em) {
        Weight weight = new Weight().datetime(DEFAULT_DATETIME).weight(DEFAULT_WEIGHT);
        return weight;
    }
    ...
    public static Weight createUpdatedEntity(EntityManager em) {
        Weight weight = new Weight().datetime(UPDATED_DATETIME).weight(UPDATED_WEIGHT);
        return weight;
    }
    ...
    void createWeight() throws Exception {
        ...
        assertThat(testWeight.getDatetime()).isEqualTo(DEFAULT_DATETIME);
    ...
    void putExistingWeight() throws Exception {
        ...
        Weight testWeight = weightList.get(weightList.size() - 1);
        assertThat(testWeight.getDatetime()).isEqualTo(UPDATED_DATETIME);
        ...
        await()
            ...
            .untilAsserted(() -> {
                ...
                assertThat(testWeightSearch.getDatetime()).isEqualTo(UPDATED_DATETIME);
