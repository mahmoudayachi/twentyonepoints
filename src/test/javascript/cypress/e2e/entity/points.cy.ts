...
describe('Points e2e test', () => {
  ...
  const pointsSample = { date: '2023-11-28' };
  ...
  describe('new Points page', () => {
    ...
    it('should create an instance of Points', () => {
      cy.get(`[data-cy="date"]`).type('2023-11-28').blur().should('have.value', '2023-11-28');

      cy.get(`[data-cy="exercice"]`).type('58383').should('have.value', '58383');
